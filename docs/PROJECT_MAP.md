...
- `docs/COMPETITION_SCHEDULE.md` - комплексы, расчёт времени, площадки и сохранённая сетка заходов.
- `docs/COMPETITION_RESULTS.md` - ввод результатов, начисление баллов, рейтинг и скрытие финала.
- `docs/COMPETITION_HANDOFF_2026-09-21.md` - зафиксированное состояние соревнований и вопросы для продолжения обсуждения.
