...
Файл `текст` в корне проекта - локальный буфер пользователя для голосовых сообщений Codex. Он намеренно игнорируется Git; не читать, не менять, не удалять и не коммитить.
