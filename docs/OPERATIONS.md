...
Если прямой маршрут VPS до Telegram API недоступен, использовать защищённый Cloudflare Worker из `infrastructure/cloudflare/telegram-relay/`. Контракт, проверка и откат описаны в `docs/TELEGRAM_RELAY.md`.
