      ...
      {tab === "cash" ? (
        <div className="grid gap-4 xl:h-[calc(100vh-11rem)] xl:min-h-[640px] xl:grid-cols-[minmax(0,1.55fr)_minmax(360px,1fr)] xl:overflow-hidden">
          ...
          <CheckoutPanel
            ...
            changeRecipient={orderApi.changeRecipient}
        ...
        <SalesHistoryPanel
          ...
          historyPage={historyApi.historyPage}
          changeHistoryPage={historyApi.changeHistoryPage}
          hasOlderOrders={historyApi.hasOlderOrders}
