...
export type ResultKind='time'|'reps'|'weight';
export type ResultComponent={name:string;kind:ResultKind};
export type WorkoutResults={components:ResultComponent[];is_final:boolean;entries:Record<string,(number|null)[]>;status:'draft'|'confirmed'};
export type ResultScore={complex_id:string;complex_name:string;component:string;kind:ResultKind;value:number;place:number;points:number};
...
export function resultText(value:number|null|undefined,kind:ResultKind) {
